export default function PrivacyPolicyPage() {
	return (
		<div className="prose mt-12">
			...
			<p>
				Nexus ('we', 'us', or 'our') provides this Privacy Policy to inform
				you of our policies and procedures regarding the collection, use and
				disclosure of personal information we may receive from users of our
				website ('Site'), accessible from https://neexus.vercel.app, and any
				other services offered by us in connection with our site (any and all of
				the foregoing the 'Services').
			</p>
			<p>
				If you have additional questions or require more information about our
				Privacy Policy, do not hesitate to contact us at infonexus@gmail.com.
				This Privacy Policy applies only to our online activities and is valid
				for visitors to our website with regards to the information that they
				shared and/or collect in Nexus. This policy is not applicable to any
				information collected offline or via channels other than this website
			</p>
			<h2 className="text-foreground">Consent</h2>
			<p>
			...
			<p>
				Personal Information:When you sign up, we are provided with your name,
				email, and profile picture which comes from your google account
				information or any other authentication provider. We use this information
				for personalization and any essential communication with you. We never
				sell your data.
			</p>
			<p>
				Voluntary Correspondence: We retain questions or assistance requests,
				including your email, for future reference.
			</p>
			<p>
				Marketing Communications: Your email is processed for direct marketing
				and support. Unsubscribe anytime, and we promptly delete your
				information upon request.
			</p>
			<h2 className="text-foreground">Your Data</h2>
			<p>
			...
			<h2 className="text-foreground">Links to Other Sites</h2>
			<p>
				...
				on another third party link, you will be directed to that third party's
				website, application, or online service. The fact that we link to a
				website, content is not an endorsement, authorization or representation
				of our affiliation with that third party, nor is it an endorsement of
				their privacy or information security policies or practices. We do not
				exercise control over third party websites or services.
			</p>
			<h2 className="text-foreground">Third Party Privacy Policies</h2>
			<p>
			...
			<h2 className="text-foreground">GDPR Data Protection Rights</h2>
			<p>
			...
			<p>
				...
				reflected by a 'Last modified' date below. Thus, we advise you to review
